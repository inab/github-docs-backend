...
public class ReposQuery {
    ...
    public String getReposWithTopic(String[] topic) {
        ...
        ArrayList topicsArrayList = new ArrayList<String>();
        ...
        for (Object o : reposArray) {
            ...
            //compare the two lists to check if all the topics defined by user are present in topiclist from repo
